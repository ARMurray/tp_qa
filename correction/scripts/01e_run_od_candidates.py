...
def restrict_to_training_corrections(cands: pd.DataFrame) -> pd.DataFrame:
...
def main():
    ...
    ap.add_argument("--all", action="store_true",
                    help="every plant in stage2_candidates, not just holdout. "
                         ...
                         "holdout first.")
    ap.add_argument("--training-corrections", action="store_true",
    ...
    # Training-scope output goes to its own root. Keeping it apart from the
